...
#  Default: set()
# c.JupyterHub.admin_users = set(["g4admin"])
...
#  Default: '/home/g4user/.local/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/g4user/.local/share/jupyterhub'
...
#  Default: set()
c.Authenticator.admin_users = set(["g4admin"])
...
#  Default: set()
c.Authenticator.allowed_users = set(['g4admin','g4user1','g4user2','g4user3'])
...
c.Spawner.env_keep = ['JUPYTERHUB_SINGLEUSER_APP','PATH','LD_PRELOAD','LD_LIBRARY_PATH','PYTHONPATH','GEANT4_DATA_DIR']
...
#  Default: ''
c.Spawner.notebook_dir = '/opt/data/'
